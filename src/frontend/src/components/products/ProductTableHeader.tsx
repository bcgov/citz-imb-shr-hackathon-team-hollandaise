...
const ProductTableHeader = ({ query, setQuery, selectedColumn, setSelectedColumn, openAddNew }) => {
  return (
    ...
    <Grid align="center" mb="md">
      ...
      <Grid.Col xs={2} mt="xl">
        ...
        <Button fullWidth={true} color="blue" variant="outline" onClick={openAddNew}>
          Add New
        </Button>
      </Grid.Col>
    </Grid>
